...
import { BootstrapReactGridLayoutBuilder, connectReactGridLayoutBuilder, withOpeningDock } from '../../../src';
import { Grid, Row, Col } from 'react-bootstrap';

const WidthProvider = require('react-grid-layout').WidthProvider;
const ResponsiveReactGridLayout = connectReactGridLayoutBuilder(WidthProvider(Responsive));
const DockedReactGridLayoutBuilder = withOpeningDock(BootstrapReactGridLayoutBuilder);

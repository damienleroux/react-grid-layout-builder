...
var connectReactGridLayoutBuilderToEditor = exports.connectReactGridLayoutBuilderToEditor = function connectReactGridLayoutBuilderToEditor(Editor) {
	return function (_Component) {
		...
		function _class2() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(_class2)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.editConfigCallback = function (event) {
				if (event) {
					if (event.target) {

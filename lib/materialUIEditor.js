...
function Breakpoints(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(BreakpointInput, { name: 'lg', value: lg, label: 'largeee', editConfigCallback: props.editConfigCallback }),
    _react2.default.createElement(BreakpointInput, { name: 'md', value: md, label: 'mediumee', editConfigCallback: props.editConfigCallback }),
    _react2.default.createElement(BreakpointInput, { name: 'sm', value: sm, label: 'smallee', editConfigCallback: props.editConfigCallback }),
    _react2.default.createElement(BreakpointInput, { name: 'xs', value: xs, label: 'extra smallee', editConfigCallback: props.editConfigCallback }),
    _react2.default.createElement(BreakpointInput, { name: 'xxs', value: xxs, label: 'extra extra smallee', editConfigCallback: props.editConfigCallback })
  );
}

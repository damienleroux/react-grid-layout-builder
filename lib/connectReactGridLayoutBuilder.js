...
function getReactGridLayoutFromProps(props) {
  ...
  var updateConfigFunc = props.updateConfigFunc;

  var reactGridLayout = _objectWithoutProperties(props, ["children", "updateConfigFunc"]);
...
var connectReactGridLayoutBuilder = function connectReactGridLayoutBuilder(ReactGridLayout) {
  ...
  return _temp2 = _class = function (_Component) {
    ...
    function _class() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(_class)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onLayoutChange = function (currentLayout, allLayouts) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          }, _defineProperty(_extends2, "onResizeStart", this.onResizeStart), _defineProperty(_extends2, "onResize", this.onResize), _defineProperty(_extends2, "onResizeStop", this.onResizeStop), _defineProperty(_extends2, "onWidthChange", this.onWidthChange), _defineProperty(_extends2, "onBreakpointChange", this.onBreakpointChange), _defineProperty(_extends2, "onLayoutChange", this.onLayoutChange), _extends2)),
          children
        );
      }
    }]);
    ...
    return _class;
  }(_react.Component), _class.propTypes = Object.assign({}, ReactGridLayout.propTypes, {
    updateConfigFunc: _react.PropTypes.func.isRequired
  }), _temp2;
};
